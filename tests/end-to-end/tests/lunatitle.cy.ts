...
describe('Luna Title component', function () {
  ...
  it('renders correctly in edit mode', function () {
    ...
    cy.getByTestId('ModalDialog_LunaTitle').findByTestId('RadioElement_h1').click();
    cy.getByTestId('ModalDialog_LunaTitle').findByTestId('RadioElement_hl-title__heading--size-2').click();
    cy.getByTestId('ModalDialog_LunaTitle').findByTestId('Input_Headingtext').clear().type('New heading');
    cy.getByTestId('ModalDialog_LunaTitle').findByTestId('Input_Addanoverline').click();
    cy.getByTestId('ModalDialog_LunaTitle').findByTestId('Input_Overlinetext').clear().type('New overline text');
